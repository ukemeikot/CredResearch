...
export function ProjectsDashboard() {
  ...
  return (
    <div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            ...
            {me.data && !me.data.emailVerified && (
              <span className="ml-2 rounded-full border border-amber-400/40 px-2 py-0.5 text-xs text-amber-600">
                email unverified
              </span>
            )}
          </p>
      ...
      <h2 className="mt-12 mb-4 font-display text-lg font-semibold uppercase tracking-wider text-slate-900">
        Your projects
      </h2>
      ...
      {projects.isLoading ? (
        ...
        <GlassCard className="p-6 text-sm text-rose-600">
        ...
        <GlassCard className="flex flex-col items-center gap-4 p-12 text-center">
          ...
          <div>
            <p className="font-display text-lg text-slate-900">No projects yet</p>
            <p className="mt-1 text-sm text-slate-500">Create your first research project to get started.</p>
          </div>
